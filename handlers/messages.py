...
from config.client_loader import get_client_config, get_hermes_profile, get_prompt_file
...
async def process_incoming_message(
    ...
    # Load client config
    client_config = get_client_config(instance_name)
    logger.info(f"Processando mensagem de {message.from_number} (client={client_config.get('name', instance_name)}): {message.content[:100]}...")
    ...
    system_prompt = _load_prompt(get_prompt_file(instance_name))
